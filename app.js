...
/*
Alternative approach using the method filter() and arrow function.
*/
...
// Assuming I know where it is. (Direct Index Access)
// let num = numArrays[2][1];

// Assuming I don't even know if it exists. (Dynamic Search)
let num = -1;

for (let numArray of numArrays) {
    let index = numArray.indexOf(66);
    if (index > 0) {
        num = numArray[index];
        break;
    }
